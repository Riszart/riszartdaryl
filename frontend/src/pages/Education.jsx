  ...
  return (
    <main className="p-5 pb-30">
      <section className="mb-5">
        ...
        <h2 className="capitalize text-6xl font-bold mb-6">mis <span className="mt-2 bg-linear-to-r from-cyber-green via-cyber-white to-cyber-skyblue bg-clip-text text-transparent drop-shadow-[0_0_30px_var(--color-cyber-green-shadow)]">estudios</span></h2>
